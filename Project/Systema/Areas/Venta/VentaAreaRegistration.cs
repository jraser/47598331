     ...
     defaults: new { controller = "ListaPrecio", action = "List" });
         ...
         defaults: new { controller = "Requerimientos", action = "List" });
          ...
          defaults: new { controller = "Almacen", action = "List" });
            ...
            name: "UnidadList",
            url: "Unidad/List",
            defaults: new { controller = "Unidad", action = "List" });

            context.MapRoute(
            name: "UnidadCreate",
            url: "Unidad/Create",
            defaults: new { controller = "Unidad", action = "Create" });

            context.MapRoute(
            name: "UnidadAdd",
            url: "Unidad/CreateAdd",
            defaults: new { controller = "Unidad", action = "CreateAdd" });
            //--------------------------------------------------------------
          ...
          context.MapRoute(
          name: "DetalleUMCreate",
          url: "DetalleUM/Create",
          defaults: new { controller = "DetalleUM", action = "Create" });

         context.MapRoute(
         name: "LPrecioCreate",
         url: "Precio/LCreate",
         defaults: new { controller = "Precio", action = "LCreate" });
         ...
         defaults: new { controller = "OVAdd", action = "ListAdd" });
          ...
          context.MapRoute(
           name: "DescuentoAddDescuento",
           url: "Descuento/AddDescuento",
           defaults: new { controller = "Descuento", action = "AddDescuento" });       
        }
