         ...
         .state('OVModific', {
             ...
             .state('DetalleOVCreate', {
                 ...
                 .state('OVAddListAdd', {
                    ...
                    .state('SocioNegocioGrupoSN', {
                        url: '/SocioNegocioGrupoSN',
                        views: {
                            "containerOne": {
                                templateUrl: "SocioNegocio/GrupoSN",
                                controller: GrupoSNController
                            }
                        }
                    })
                            .state('SocioNegocioGrupoSNAdd', {
                                url: '/SocioNegocioGrupoSNAdd',
                                views: {
                                    "containerOne": {
                                        templateUrl: "SocioNegocio/GrupoSNAdd",
                                        controller: GrupoSNController
                                    }
                                }
                            })

             .state('DescuentoAddDescuento', {
                 url: '/DescuentoAddDescuento',
                 views: {
                     "containerOne": {
                 ...
                 .state('SocioNegocioAddSNGrupo', {
                     url: '/SocioNegocioAddSNGrupo',
                     views: {
                         "containerOne": {
                             templateUrl: "SocioNegocio/AddSNGrupo",
                             controller: AddSNGrupoController
                         }
                     }
                 })
                        .state('SocioNegocioGrupoProductos', {
                            url: '/SocioNegocioGrupoProductos',
                            views: {
                                "containerOne": {
                                    templateUrl: "SocioNegocio/GrupoProductos",
                                    controller: GrupoProductosController
                                }
                            }
                        })
                                .state('SocioNegocioGrupoProductosAdd', {
                                    url: '/SocioNegocioGrupoProductosAdd',
                                    views: {
                                        "containerOne": {
                                            templateUrl: "SocioNegocio/GrupoProductosAdd",
                                            controller: GrupoProductosController
                                        }
                                    }
                                })
                     .state('SocioNegocioAddProductosGrupo', {
                         url: '/SocioNegocioAddProductosGrupo',
                         views: {
                             "containerOne": {
...
MetronicApp.controller('EmpresaController', EmpresaController);
...
MetronicApp.controller('GrupoSNController', GrupoSNController);
MetronicApp.controller('AddSNGrupoController', AddSNGrupoController);
MetronicApp.controller('DetalleRequerimientosController', DetalleRequerimientosController);
