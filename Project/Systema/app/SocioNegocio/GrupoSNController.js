var GrupoSNController = function ($rootScope, $scope, $state, $stateParams, $http, $modal) {
    ...
    $scope.Create = function () {
        $('#Id').val('0');
        $state.go('SocioNegocioGrupoSNAdd');
    }

    $scope.Cancel = function () {
        $('#Id').val('0');
        $state.go('SocioNegocioGrupoSN');
    }
...
GrupoSNController.$inject = ['$rootScope', '$scope', '$state', '$stateParams', '$http', '$modal'];
